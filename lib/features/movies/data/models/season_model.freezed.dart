...
@HiveField(0)@StringToIntConverterRequired() int get season;@HiveField(1) List<EpisodeModel> get episodes;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SeasonModel&&(identical(other.season, season) || other.season == season)&&const DeepCollectionEquality().equals(other.episodes, episodes));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,season,const DeepCollectionEquality().hash(episodes));
...
@useResult
$Res call({
@HiveField(0)@StringToIntConverterRequired() int season,@HiveField(1) List<EpisodeModel> episodes
});
...
/// Create a copy of SeasonModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? season = null,Object? episodes = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)@StringToIntConverterRequired()  int season, @HiveField(1)  List<EpisodeModel> episodes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SeasonModel() when $default != null:
return $default(_that.season,_that.episodes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)@StringToIntConverterRequired()  int season, @HiveField(1)  List<EpisodeModel> episodes)  $default,) {final _that = this;
switch (_that) {
case _SeasonModel():
return $default(_that.season,_that.episodes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@HiveField(0)@StringToIntConverterRequired()  int season, @HiveField(1)  List<EpisodeModel> episodes)?  $default,) {final _that = this;
switch (_that) {
case _SeasonModel() when $default != null:
return $default(_that.season,_that.episodes);case _:
  return null;
...
class _SeasonModel implements SeasonModel {
  const _SeasonModel({@HiveField(0)@StringToIntConverterRequired() required this.season, @HiveField(1) final  List<EpisodeModel> episodes = const []}): _episodes = episodes;
  factory _SeasonModel.fromJson(Map<String, dynamic> json) => _$SeasonModelFromJson(json);

@override@HiveField(0)@StringToIntConverterRequired() final  int season;
 final  List<EpisodeModel> _episodes;
@override@JsonKey()@HiveField(1) List<EpisodeModel> get episodes {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SeasonModel&&(identical(other.season, season) || other.season == season)&&const DeepCollectionEquality().equals(other._episodes, _episodes));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,season,const DeepCollectionEquality().hash(_episodes));
...
/// Create a copy of SeasonModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? season = null,Object? episodes = null,}) {
