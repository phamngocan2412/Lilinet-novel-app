...
mixin _$Episode {
 ...
 String get id; String get title; String? get description; int get number; int? get season; String? get image; String? get url; DateTime? get releaseDate;
...
@useResult
$Res call({
 String id, String title, String? description, int number, int? season, String? image, String? url, DateTime? releaseDate
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String? description,  int number,  int? season,  String? image,  String? url,  DateTime? releaseDate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Episode() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String? description,  int number,  int? season,  String? image,  String? url,  DateTime? releaseDate)  $default,) {final _that = this;
switch (_that) {
case _Episode():
return $default(_that.id,_that.title,_that.description,_that.number,_that.season,_that.image,_that.url,_that.releaseDate);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String? description,  int number,  int? season,  String? image,  String? url,  DateTime? releaseDate)?  $default,) {final _that = this;
switch (_that) {
case _Episode() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.number,_that.season,_that.image,_that.url,_that.releaseDate);case _:
  return null;
...
class _Episode implements Episode {
  const _Episode({required this.id, required this.title, this.description, required this.number, this.season, this.image, this.url, this.releaseDate});
