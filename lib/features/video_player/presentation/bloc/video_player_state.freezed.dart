...
mixin _$VideoPlayerState {
 ...
 VideoPlayerStatus get status; String? get episodeId; String? get mediaId; String? get title; String? get posterUrl; String? get episodeTitle; Duration? get startPosition; String? get mediaType; Movie? get movie; int? get timestamp;
...
@override
int get hashCode => Object.hash(runtimeType,status,episodeId,mediaId,title,posterUrl,episodeTitle,startPosition,mediaType,movie,timestamp);
...
@useResult
$Res call({
 VideoPlayerStatus status, String? episodeId, String? mediaId, String? title, String? posterUrl, String? episodeTitle, Duration? startPosition, String? mediaType, Movie? movie, int? timestamp
});
...
/// Create a copy of VideoPlayerState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? episodeId = freezed,Object? mediaId = freezed,Object? title = freezed,Object? posterUrl = freezed,Object? episodeTitle = freezed,Object? startPosition = freezed,Object? mediaType = freezed,Object? movie = freezed,Object? timestamp = freezed,}) {
  return _then(_self.copyWith(
status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as VideoPlayerStatus,episodeId: freezed == episodeId ? _self.episodeId : episodeId // ignore: cast_nullable_to_non_nullable
...
as String?,episodeTitle: freezed == episodeTitle ? _self.episodeTitle : episodeTitle // ignore: cast_nullable_to_non_nullable
as String?,startPosition: freezed == startPosition ? _self.startPosition : startPosition // ignore: cast_nullable_to_non_nullable
as Duration?,mediaType: freezed == mediaType ? _self.mediaType : mediaType // ignore: cast_nullable_to_non_nullable
as String?,movie: freezed == movie ? _self.movie : movie // ignore: cast_nullable_to_non_nullable
as Movie?,timestamp: freezed == timestamp ? _self.timestamp : timestamp // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
/// Create a copy of VideoPlayerState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( VideoPlayerStatus status,  String? episodeId,  String? mediaId,  String? title,  String? posterUrl,  String? episodeTitle,  Duration? startPosition,  String? mediaType,  Movie? movie,  int? timestamp)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VideoPlayerState() when $default != null:
return $default(_that.status,_that.episodeId,_that.mediaId,_that.title,_that.posterUrl,_that.episodeTitle,_that.startPosition,_that.mediaType,_that.movie,_that.timestamp);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( VideoPlayerStatus status,  String? episodeId,  String? mediaId,  String? title,  String? posterUrl,  String? episodeTitle,  Duration? startPosition,  String? mediaType,  Movie? movie,  int? timestamp)  $default,) {final _that = this;
switch (_that) {
case _VideoPlayerState():
return $default(_that.status,_that.episodeId,_that.mediaId,_that.title,_that.posterUrl,_that.episodeTitle,_that.startPosition,_that.mediaType,_that.movie,_that.timestamp);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( VideoPlayerStatus status,  String? episodeId,  String? mediaId,  String? title,  String? posterUrl,  String? episodeTitle,  Duration? startPosition,  String? mediaType,  Movie? movie,  int? timestamp)?  $default,) {final _that = this;
switch (_that) {
case _VideoPlayerState() when $default != null:
return $default(_that.status,_that.episodeId,_that.mediaId,_that.title,_that.posterUrl,_that.episodeTitle,_that.startPosition,_that.mediaType,_that.movie,_that.timestamp);case _:
  return null;
...
class _VideoPlayerState implements VideoPlayerState {
  const _VideoPlayerState({this.status = VideoPlayerStatus.closed, this.episodeId, this.mediaId, this.title, this.posterUrl, this.episodeTitle, this.startPosition, this.mediaType, this.movie, this.timestamp});
  

@override@JsonKey() final  VideoPlayerStatus status;
...
@override final  Duration? startPosition;
...
/// Create a copy of VideoPlayerState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? episodeId = freezed,Object? mediaId = freezed,Object? title = freezed,Object? posterUrl = freezed,Object? episodeTitle = freezed,Object? startPosition = freezed,Object? mediaType = freezed,Object? movie = freezed,Object? timestamp = freezed,}) {
