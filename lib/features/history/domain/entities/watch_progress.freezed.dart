...
mixin _$WatchProgress {
 ...
 String get mediaId; String get title; String? get posterUrl; String? get episodeId; String? get episodeTitle; int get positionSeconds; int get durationSeconds; DateTime get lastUpdated; bool get isFinished;
...
@override
int get hashCode => Object.hash(runtimeType,mediaId,title,posterUrl,episodeId,episodeTitle,positionSeconds,durationSeconds,lastUpdated,isFinished);
...
@useResult
$Res call({
 String mediaId, String title, String? posterUrl, String? episodeId, String? episodeTitle, int positionSeconds, int durationSeconds, DateTime lastUpdated, bool isFinished
});
...
/// Create a copy of WatchProgress
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? mediaId = null,Object? title = null,Object? posterUrl = freezed,Object? episodeId = freezed,Object? episodeTitle = freezed,Object? positionSeconds = null,Object? durationSeconds = null,Object? lastUpdated = null,Object? isFinished = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String mediaId,  String title,  String? posterUrl,  String? episodeId,  String? episodeTitle,  int positionSeconds,  int durationSeconds,  DateTime lastUpdated,  bool isFinished)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WatchProgress() when $default != null:
return $default(_that.mediaId,_that.title,_that.posterUrl,_that.episodeId,_that.episodeTitle,_that.positionSeconds,_that.durationSeconds,_that.lastUpdated,_that.isFinished);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String mediaId,  String title,  String? posterUrl,  String? episodeId,  String? episodeTitle,  int positionSeconds,  int durationSeconds,  DateTime lastUpdated,  bool isFinished)  $default,) {final _that = this;
switch (_that) {
case _WatchProgress():
return $default(_that.mediaId,_that.title,_that.posterUrl,_that.episodeId,_that.episodeTitle,_that.positionSeconds,_that.durationSeconds,_that.lastUpdated,_that.isFinished);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String mediaId,  String title,  String? posterUrl,  String? episodeId,  String? episodeTitle,  int positionSeconds,  int durationSeconds,  DateTime lastUpdated,  bool isFinished)?  $default,) {final _that = this;
switch (_that) {
case _WatchProgress() when $default != null:
return $default(_that.mediaId,_that.title,_that.posterUrl,_that.episodeId,_that.episodeTitle,_that.positionSeconds,_that.durationSeconds,_that.lastUpdated,_that.isFinished);case _:
  return null;
...
class _WatchProgress implements WatchProgress {
  const _WatchProgress({required this.mediaId, required this.title, this.posterUrl, this.episodeId, this.episodeTitle, required this.positionSeconds, required this.durationSeconds, required this.lastUpdated, required this.isFinished});
...
/// Create a copy of WatchProgress
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? mediaId = null,Object? title = null,Object? posterUrl = freezed,Object? episodeId = freezed,Object? episodeTitle = freezed,Object? positionSeconds = null,Object? durationSeconds = null,Object? lastUpdated = null,Object? isFinished = null,}) {
