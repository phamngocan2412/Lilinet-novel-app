...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( CheckAuthStatus value)?  checkAuthStatus,TResult Function( SignInRequested value)?  signInRequested,TResult Function( AuthSubmitted value)?  authSubmitted,TResult Function( SignUpRequested value)?  signUpRequested,TResult Function( SignOutRequested value)?  signOutRequested,TResult Function( AuthStateChanged value)?  authStateChanged,TResult Function( PasswordResetRequested value)?  passwordResetRequested,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( CheckAuthStatus value)  checkAuthStatus,required TResult Function( SignInRequested value)  signInRequested,required TResult Function( AuthSubmitted value)  authSubmitted,required TResult Function( SignUpRequested value)  signUpRequested,required TResult Function( SignOutRequested value)  signOutRequested,required TResult Function( AuthStateChanged value)  authStateChanged,required TResult Function( PasswordResetRequested value)  passwordResetRequested,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( CheckAuthStatus value)?  checkAuthStatus,TResult? Function( SignInRequested value)?  signInRequested,TResult? Function( AuthSubmitted value)?  authSubmitted,TResult? Function( SignUpRequested value)?  signUpRequested,TResult? Function( SignOutRequested value)?  signOutRequested,TResult? Function( AuthStateChanged value)?  authStateChanged,TResult? Function( PasswordResetRequested value)?  passwordResetRequested,}){
final _that = this;
switch (_that) {
case CheckAuthStatus() when checkAuthStatus != null:
return checkAuthStatus(_that);case SignInRequested() when signInRequested != null:
...
class AuthSubmitted implements AuthEvent {
  const AuthSubmitted({required this.username, required this.password, required this.isLogin});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$AuthSubmittedCopyWith<AuthSubmitted> get copyWith => _$AuthSubmittedCopyWithImpl<AuthSubmitted>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthSubmitted&&(identical(other.username, username) || other.username == username)&&(identical(other.password, password) || other.password == password)&&(identical(other.isLogin, isLogin) || other.isLogin == isLogin));
}
...
/// @nodoc
abstract mixin class $AuthSubmittedCopyWith<$Res> implements $AuthEventCopyWith<$Res> {
  factory $AuthSubmittedCopyWith(AuthSubmitted value, $Res Function(AuthSubmitted) _then) = _$AuthSubmittedCopyWithImpl;
@useResult
$Res call({
 String username, String password, bool isLogin
});
...
/// Create a copy of AuthEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? username = null,Object? password = null,Object? isLogin = null,}) {
  return _then(AuthSubmitted(
username: null == username ? _self.username : username // ignore: cast_nullable_to_non_nullable
as String,password: null == password ? _self.password : password // ignore: cast_nullable_to_non_nullable
as String,isLogin: null == isLogin ? _self.isLogin : isLogin // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SignUpRequested&&(identical(other.email, email) || other.email == email)&&(identical(other.password, password) || other.password == password)&&(identical(other.displayName, displayName) || other.displayName == displayName));
}
