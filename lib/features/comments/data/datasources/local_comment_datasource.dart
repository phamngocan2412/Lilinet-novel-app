...
class LocalCommentDataSourceImpl implements LocalCommentDataSource {
  ...
  static String generateLocalId() {
    // SECURITY: Use Random.secure() for sensitive identifier generation
    // to prevent predictable IDs that could be vulnerable to enumeration attacks.
  ...
  static String generateGuestName() {
    // SECURITY: Use Random.secure() for guest username generation
    // to ensure unpredictability and reduce enumeration surface area.
    final random = Random.secure();
