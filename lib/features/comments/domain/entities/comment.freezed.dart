...
mixin _$Comment {
 ...
 String get id; String get videoId; String get userName; String get avatarUrl; String get content; int get likes; int get dislikes; int get repliesCount; DateTime get createdAt; DateTime? get updatedAt; List<DateTime> get likeTimestamps;// For calculating recent likes
 List<Comment> get replies; String? get parentId; String? get mediaType;// 'Movie' or 'TV Series' for navigation
 bool get isEdited; bool get isDeleted; bool get isPinned;
...
@useResult
$Res call({
 String id, String videoId, String userName, String avatarUrl, String content, int likes, int dislikes, int repliesCount, DateTime createdAt, DateTime? updatedAt, List<DateTime> likeTimestamps, List<Comment> replies, String? parentId, String? mediaType, bool isEdited, bool isDeleted, bool isPinned
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String videoId,  String userName,  String avatarUrl,  String content,  int likes,  int dislikes,  int repliesCount,  DateTime createdAt,  DateTime? updatedAt,  List<DateTime> likeTimestamps,  List<Comment> replies,  String? parentId,  String? mediaType,  bool isEdited,  bool isDeleted,  bool isPinned)  $default,) {final _that = this;
switch (_that) {
case _Comment():
return $default(_that.id,_that.videoId,_that.userName,_that.avatarUrl,_that.content,_that.likes,_that.dislikes,_that.repliesCount,_that.createdAt,_that.updatedAt,_that.likeTimestamps,_that.replies,_that.parentId,_that.mediaType,_that.isEdited,_that.isDeleted,_that.isPinned);case _:
  throw StateError('Unexpected subclass');
...
class _Comment extends Comment {
  const _Comment({required this.id, required this.videoId, required this.userName, required this.avatarUrl, required this.content, this.likes = 0, this.dislikes = 0, this.repliesCount = 0, required this.createdAt, this.updatedAt, final  List<DateTime> likeTimestamps = const [], final  List<Comment> replies = const [], this.parentId, this.mediaType, this.isEdited = false, this.isDeleted = false, this.isPinned = false}): _likeTimestamps = likeTimestamps,_replies = replies,super._();
