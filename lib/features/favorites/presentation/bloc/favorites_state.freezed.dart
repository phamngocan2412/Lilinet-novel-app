...
mixin _$FavoritesState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            ...
            List<String> folders,
            Map<String, List<Favorite>> favoritesByFolder)
        loaded,
    ...
    return _then(_$FavoritesLoadedImpl(
      ...
      folders: null == folders
          ...
          : folders // ignore: cast_nullable_to_non_nullable
              as List<String>,
      favoritesByFolder: null == favoritesByFolder
          ? _value._favoritesByFolder
          : favoritesByFolder // ignore: cast_nullable_to_non_nullable
              as Map<String, List<Favorite>>,
    ));
  }
}
...
class _$FavoritesLoadedImpl implements FavoritesLoaded {
  const _$FavoritesLoadedImpl(
      ...
      final List<String> folders = const ['All'],
      final Map<String, List<Favorite>> favoritesByFolder = const {}})
      : _favorites = favorites,
        _favoriteIds = favoriteIds,
        _folders = folders,
        _favoritesByFolder = favoritesByFolder;
  ...
  final Map<String, List<Favorite>> _favoritesByFolder;
  @override
  @JsonKey()
  Map<String, List<Favorite>> get favoritesByFolder {
    if (_favoritesByFolder is EqualUnmodifiableMapView)
      return _favoritesByFolder;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_favoritesByFolder);
  }

  @override
  String toString() {
    return 'FavoritesState.loaded(favorites: $favorites, currentPage: $currentPage, hasMore: $hasMore, favoriteIds: $favoriteIds, folders: $folders, favoritesByFolder: $favoritesByFolder)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._favoritesByFolder, _favoritesByFolder));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_favoritesByFolder));
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(favorites, currentPage, hasMore, favoriteIds, folders,
        favoritesByFolder);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(favorites, currentPage, hasMore, favoriteIds, folders,
        favoritesByFolder);
  }
...
abstract class FavoritesLoaded implements FavoritesState {
  const factory FavoritesLoaded(
          ...
          final Map<String, List<Favorite>> favoritesByFolder}) =
